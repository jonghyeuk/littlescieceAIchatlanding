  ...
  const PricingPage = () => {
    ...
    const handlePurchase = async (plan) => {
      ...
      try {
        ...
        if (result.success) {
          alert(`${plan.name} 구매가 완료되었습니다! 이메일을 확인해주세요.`);
          setEmail('');
        } else {
        ...
        <section className="pt-12 pb-8">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-slate-600 mb-8">
              연구활동에 맞는 플랜을 선택하고 AI와 함께 성공적인 연구를 시작하세요
            </p>
          </div>
        </section>
        ...
        <section className="pb-8">
          <div className="max-w-md mx-auto px-4">
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200/50">
              <h3 className="text-lg font-semibold text-slate-800 mb-4 text-center">구매자 정보</h3>
              <input
                type="email"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {plans.map((plan) => (
                <div
                  key={plan.id}
                  className={`relative bg-white rounded-2xl shadow-xl border border-slate-200/50 overflow-hidden transform transition-all duration-300 hover:scale-105 ${
                ...
                >
                  ...
                  <div className={`p-6 ${plan.popular ? 'pt-12' : ''}`}>
                    <div className={`w-12 h-12 bg-gradient-to-r ${plan.color} rounded-lg flex items-center justify-center mb-4 mx-auto`}>
                      <Beaker className="w-6 h-6 text-white" />
                    </div>
                    ...
                    <div className="text-center mb-6">
                      ...
                      {plan.originalPrice && (
                        <div className="text-slate-400 line-through text-sm">
                          원가: ₩{plan.originalPrice.toLocaleString()}
                        </div>
                      )}
                    </div>
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center space-x-8 text-slate-600 flex-wrap gap-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">즉시 이용 가능</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">연구활동 전문</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <footer className="bg-slate-900 text-slate-300 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">과학연구설계 AI</span>
            </div>
            <p className="text-slate-400 text-sm">
              © 2025 과학연구설계 AI. 모든 권리 보유. | 문의: support@scienceai.com
            </p>
          </div>
        </footer>
      </div>
