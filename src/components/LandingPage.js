      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            ...
            <button className="group bg-gradient-to-r from-orange-500 to-red-500 text-white px-10 py-5 rounded-2xl text-lg font-bold hover:from-orange-600 hover:to-red-600 transition-all shadow-2xl hover:shadow-orange-500/25 transform hover:-translate-y-1 flex items-center">
              이용권 구매
            ...
            <div id="screenshot-section" className="lg:pl-8">
              <div className="bg-slate-100 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="bg-white rounded-2xl p-4 shadow-lg">
                  ...
                  {/* 이곳에 스크린샷 삽입 - 권장 사이즈: 600x400px */}
                  <img 
                    src="YOUR_MAIN_SCREENSHOT_URL_HERE" 
                    alt="과학연구설계 AI 메인 화면" 
                    className="w-full h-64 object-cover rounded-lg bg-gradient-to-br from-blue-100 to-blue-200 border-2 border-dashed border-blue-300"
      ...
      <section className="py-24 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            ...
            <button className="group bg-gradient-to-r from-orange-500 to-red-500 text-white px-12 py-6 rounded-2xl text-xl font-bold hover:from-orange-600 hover:to-red-600 transition-all shadow-2xl hover:shadow-orange-500/25 transform hover:-translate-y-1 flex items-center">
              이용권구매
